...
import VisualizeWalletButton from "@/components/dashboard/VisualizeWalletButton"
...
export function WalletBalanceCards({ balance, isLoading }: WalletBalanceProps) {
  if (isLoading) {
    return (
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="glass-panel">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <VisualizeWalletButton walletAddress={balance.address} />
          </CardHeader>
          <CardContent>
